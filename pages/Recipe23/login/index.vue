...
<template>
  ...
  >
    ...
    >
      ...
      <form class="mt-6">
        <div>
          <label for="email" class="block text-sm text-black-800">Email</label>
          <input
            type="email"
      ...
      <!-- START SOCIAL BUTTON FOR LOGIN -->
      <div class="mt-5 tracking-normal text-center">
        <button
          type="button"
          data-te-ripple-init
